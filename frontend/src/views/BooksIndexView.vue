...
const books = computed(() => BookService.getBooks());
          ...
          >
            ...
            <div class="bg-gray-50 rounded-lg p-3 mb-4">
              <div class="flex justify-between text-sm">
                ...
                <span class="font-semibold">${{ formatPrice(book.price) }} COP</span>
              </div>
            </div>
            ...
            <div class="flex justify-center">
              ...
              >
                More info <i class="fas fa-info-circle" aria-hidden="true"></i>
              </RouterLink>
            </div>
          </div>
        </div>
